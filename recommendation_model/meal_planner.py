...
MEAL_TEMPLATES = {
    ...
    "east_breakfast": [
        ...
        [("staple","bread"), ("protein","egg"), ("protein","butter"), ("beverage","tea")],
    ...
    "east_lunch": [
        ...
        [("staple","rice"), ("protein","fish curry"), ("protein","dal"), ("vegetable","begun bhaja"), ("accompaniment","papad")],
        [("staple","rice"), ("protein","macher jhol"), ("protein","dal"), ("vegetable","aloo bhaja"), ("accompaniment","salad")],
        [("staple","rice"), ("protein","kosha mangsho"), ("protein","dal"), ("vegetable","sabzi"), ("accompaniment","papad")],
        [("staple","rice"), ("protein","shorshe ilish"), ("protein","dal"), ("vegetable","bhaja"), ("accompaniment","papad")],
        [("staple","rice"), ("protein","egg curry"), ("protein","dal"), ("vegetable","aloo posto"), ("accompaniment","papad")],
        [("staple","rice"), ("protein","chingri malai curry"), ("protein","dal"), ("vegetable","sabzi"), ("accompaniment","papad")],
        [("staple","rice"), ("protein","dalma"), ("vegetable","sabzi"), ("accompaniment","papad")],
        [("staple","rice"), ("protein","chicken curry"), ("protein","dal"), ("vegetable","sabzi"), ("accompaniment","salad")],
        [("staple","rice"), ("protein","moong dal"), ("vegetable","aloo posto"), ("accompaniment","papad")],
    ],
    "east_lunch_weekend": [
        # Weekend cheat meals — Bengali style
        [("staple","chicken biryani"), ("accompaniment","raita"), ("accompaniment","salad")],
        [("staple","mutton biryani"), ("accompaniment","raita"), ("accompaniment","salad")],
        [("staple","egg biryani"), ("accompaniment","raita"), ("accompaniment","salad")],
        [("staple","fried rice"), ("protein","chicken curry"), ("accompaniment","salad")],
        [("staple","chowmein"), ("protein","chicken curry"), ("accompaniment","salad")],
    ],
    "east_dinner": [
        # Lighter than lunch — roti/chapati based
        [("staple","roti"), ("protein","egg curry"), ("vegetable","aloo sabzi"), ("accompaniment","salad")],
        [("staple","roti"), ("protein","fish curry"), ("vegetable","sabzi"), ("accompaniment","pickle")],
        [("staple","chapati"), ("protein","dal"), ("vegetable","sabzi"), ("accompaniment","raita")],
        [("staple","roti"), ("protein","aloo sabzi"), ("vegetable","sabzi"), ("accompaniment","salad")],
        [("staple","khichdi"), ("protein","dal"), ("accompaniment","pickle"), ("accompaniment","papad")],
        [("staple","luchi"), ("protein","cholar dal"), ("vegetable","sabzi"), ("accompaniment","salad")],
        [("staple","roti"), ("protein","chicken curry"), ("vegetable","sabzi"), ("accompaniment","raita")],
    ],
    "east_dinner_weekend": [
        [("staple","fried rice"), ("protein","chicken curry"), ("accompaniment","salad")],
        [("staple","chowmein"), ("protein","chicken manchurian"), ("accompaniment","salad")],
    ...
    "north_breakfast": [
        ...
        [("staple","paratha"), ("protein","aloo"), ("accompaniment","pickle"), ("beverage","chai")],
        [("staple","bread"), ("protein","butter"), ("protein","omelette"), ("beverage","tea")],
        [("staple","bread"), ("protein","egg"), ("protein","butter"), ("beverage","tea")],
    ...
    "north_lunch": [
        [("staple","roti"), ("protein","dal makhani"), ("vegetable","sabzi"), ("accompaniment","raita"), ("beverage","lassi")],
        [("staple","roti"), ("protein","rajma"), ("vegetable","sabzi"), ("accompaniment","salad"), ("beverage","lassi")],
        ...
        [("staple","roti"), ("protein","chole"), ("vegetable","sabzi"), ("accompaniment","onion"), ("beverage","lassi")],
        ...
        [("staple","roti"), ("protein","mutton curry"), ("vegetable","sabzi"), ("accompaniment","raita")],
        [("staple","rice"), ("protein","dal"), ("vegetable","sabzi"), ("accompaniment","papad")],
    ],
    "north_lunch_weekend": [
        [("staple","chicken biryani"), ("accompaniment","raita"), ("accompaniment","salad")],
        [("staple","mutton biryani"), ("accompaniment","raita"), ("accompaniment","salad")],
        [("staple","chole bhature"), ("accompaniment","onion"), ("accompaniment","pickle")],
        [("staple","paneer biryani"), ("accompaniment","raita"), ("accompaniment","salad")],
    ],
    "north_dinner": [
        ...
        [("staple","chapati"), ("protein","egg bhurji"), ("vegetable","sabzi"), ("accompaniment","pickle")],
        [("staple","khichdi"), ("protein","dal"), ("accompaniment","papad"), ("accompaniment","curd")],
        [("staple","roti"), ("protein","dal"), ("vegetable","bhindi"), ("accompaniment","salad")],
        [("staple","roti"), ("protein","chicken curry"), ("vegetable","sabzi"), ("accompaniment","raita")],
        [("staple","chapati"), ("protein","aloo sabzi"), ("protein","dal"), ("accompaniment","pickle")],
    ],
    "north_dinner_weekend": [
        [("staple","paratha"), ("protein","paneer"), ("accompaniment","raita"), ("accompaniment","pickle")],
        [("staple","naan"), ("protein","butter chicken"), ("protein","dal"), ("accompaniment","raita")],
        [("staple","roti"), ("protein","mutton curry"), ("vegetable","sabzi"), ("accompaniment","raita")],
    ],
    ...
    "south_breakfast": [
        ...
        [("staple","dosa"), ("protein","sambar"), ("accompaniment","coconut chutney"), ("beverage","coffee")],
        [("staple","upma"), ("protein","coconut chutney"), ("beverage","coffee")],
        [("staple","pongal"), ("protein","sambar"), ("accompaniment","coconut chutney"), ("beverage","coffee")],
        ...
        [("staple","rava idli"), ("protein","sambar"), ("accompaniment","chutney"), ("beverage","coffee")],
    ],
    "south_lunch": [
        [("staple","rice"), ("protein","sambar"), ("vegetable","poriyal"), ("accompaniment","rasam"), ("accompaniment","papad")],
        [("staple","rice"), ("protein","rasam"), ("vegetable","kootu"), ("accompaniment","papad"), ("accompaniment","curd")],
        [("staple","rice"), ("protein","fish curry"), ("vegetable","thoran"), ("accompaniment","curd")],
        [("staple","rice"), ("protein","avial"), ("vegetable","poriyal"), ("accompaniment","papad")],
        [("staple","rice"), ("protein","chicken curry"), ("vegetable","poriyal"), ("accompaniment","rasam")],
        [("staple","rice"), ("protein","prawn curry"), ("vegetable","thoran"), ("accompaniment","curd")],
        [("staple","rice"), ("protein","egg curry"), ("vegetable","poriyal"), ("accompaniment","papad")],
    ],
    "south_lunch_weekend": [
        [("staple","chicken biryani"), ("accompaniment","raita"), ("accompaniment","salad")],
        [("staple","mutton biryani"), ("accompaniment","raita"), ("accompaniment","salad")],
        [("staple","fish biryani"), ("accompaniment","raita"), ("accompaniment","salad")],
        [("staple","meals rice"), ("protein","sambar"), ("vegetable","poriyal"), ("accompaniment","papad"), ("accompaniment","payasam")],
    ],
    "south_dinner": [
        ...
        [("staple","chapati"), ("protein","chicken curry"), ("vegetable","sabzi"), ("accompaniment","raita")],
    ],
    "south_dinner_weekend": [
        [("staple","fried rice"), ("protein","chicken curry"), ("accompaniment","salad")],
        [("staple","parotta"), ("protein","chicken curry"), ("accompaniment","raita")],
        [("staple","naan"), ("protein","paneer"), ("protein","dal"), ("accompaniment","raita")],
    ],
    ...
    "west_breakfast": [
        ...
        [("staple","thepla"), ("protein","curd"), ("accompaniment","pickle"), ("beverage","chai")],
        [("staple","dhokla"), ("accompaniment","green chutney"), ("beverage","chai")],
        [("staple","bread"), ("protein","butter"), ("protein","egg"), ("beverage","chai")],
        [("staple","bread"), ("protein","omelette"), ("beverage","chai")],
        [("staple","idli"), ("protein","sambar"), ("accompaniment","coconut chutney"), ("beverage","coffee")],
        [("staple","sabudana khichdi"), ("protein","peanuts"), ("beverage","chai")],
    ],
    "west_lunch": [
        [("staple","rice"), ("protein","dal"), ("vegetable","sabzi"), ("accompaniment","papad"), ("accompaniment","curd")],
        [("staple","roti"), ("protein","dal"), ("vegetable","sabzi"), ("accompaniment","curd")],
        [("staple","rice"), ("protein","fish curry"), ("vegetable","sabzi"), ("accompaniment","papad")],
        [("staple","roti"), ("protein","paneer"), ("vegetable","sabzi"), ("accompaniment","raita")],
        [("staple","rice"), ("protein","chicken curry"), ("vegetable","sabzi"), ("accompaniment","papad")],
        [("staple","roti"), ("protein","chole"), ("vegetable","sabzi"), ("accompaniment","salad")],
    ],
    "west_lunch_weekend": [
        [("staple","chicken biryani"), ("accompaniment","raita"), ("accompaniment","salad")],
        [("staple","mutton biryani"), ("accompaniment","raita"), ("accompaniment","salad")],
    ...
    "west_dinner": [
        [("staple","roti"), ("protein","dal"), ("vegetable","sabzi"), ("accompaniment","curd")],
        [("staple","chapati"), ("protein","egg curry"), ("vegetable","sabzi"), ("accompaniment","pickle")],
        [("staple","khichdi"), ("protein","dal"), ("accompaniment","papad"), ("accompaniment","curd")],
        [("staple","roti"), ("protein","chicken curry"), ("vegetable","sabzi"), ("accompaniment","raita")],
    ...
    "central_lunch": [
        [("staple","rice"), ("protein","dal"), ("vegetable","sabzi"), ("accompaniment","papad")],
        [("staple","roti"), ("protein","dal"), ("vegetable","sabzi"), ("accompaniment","curd")],
        [("staple","rice"), ("protein","chicken curry"), ("vegetable","sabzi"), ("accompaniment","salad")],
        [("staple","roti"), ("protein","paneer"), ("vegetable","sabzi"), ("accompaniment","raita")],
    ],
    ...
    "any_breakfast": [
        ...
        [("staple","poha"), ("protein","dahi"), ("beverage","chai")],
        [("staple","upma"), ("protein","coconut chutney"), ("beverage","coffee")],
        [("staple","idli"), ("protein","sambar"), ("accompaniment","chutney"), ("beverage","coffee")],
    ...
    "any_lunch": [
        ...
        [("staple","rice"), ("protein","fish curry"), ("protein","dal"), ("vegetable","sabzi"), ("accompaniment","papad")],
        [("staple","rice"), ("protein","chicken curry"), ("protein","dal"), ("vegetable","sabzi"), ("accompaniment","raita")],
        [("staple","rice"), ("protein","egg curry"), ("protein","dal"), ("vegetable","sabzi"), ("accompaniment","papad")],
        ...
        [("staple","rice"), ("protein","mutton curry"), ("protein","dal"), ("vegetable","sabzi"), ("accompaniment","raita")],
    ],
    "any_lunch_weekend": [
        [("staple","chicken biryani"), ("accompaniment","raita"), ("accompaniment","kachumber")],
        [("staple","mutton biryani"), ("accompaniment","raita"), ("accompaniment","salad")],
        [("staple","egg biryani"), ("accompaniment","raita"), ("accompaniment","salad")],
        [("staple","veg biryani"), ("accompaniment","raita"), ("accompaniment","salad")],
        [("staple","fried rice"), ("protein","chicken curry"), ("accompaniment","salad")],
        [("staple","chowmein"), ("protein","chicken manchurian"), ("accompaniment","salad")],
        [("staple","chole bhature"), ("accompaniment","onion"), ("accompaniment","pickle")],
        [("staple","pav bhaji"), ("protein","butter"), ("accompaniment","onion")],
    ...
    "any_dinner": [
        ...
        [("staple","roti"), ("protein","dal"), ("vegetable","palak"), ("accompaniment","raita")],
        [("staple","chapati"), ("protein","egg bhurji"), ("vegetable","sabzi"), ("accompaniment","salad")],
        [("staple","khichdi"), ("protein","dal"), ("accompaniment","papad"), ("accompaniment","curd")],
        [("staple","roti"), ("protein","paneer"), ("vegetable","bhindi"), ("accompaniment","salad")],
        [("staple","roti"), ("protein","dal"), ("vegetable","aloo sabzi"), ("accompaniment","pickle")],
        [("staple","chapati"), ("protein","chicken curry"), ("vegetable","sabzi"), ("accompaniment","raita")],
        [("staple","roti"), ("protein","fish curry"), ("vegetable","sabzi"), ("accompaniment","salad")],
        [("staple","roti"), ("protein","egg curry"), ("vegetable","sabzi"), ("accompaniment","pickle")],
    ],
    "any_dinner_weekend": [
        [("staple","fried rice"), ("protein","chicken curry"), ("accompaniment","salad")],
        [("staple","chowmein"), ("protein","chicken manchurian"), ("accompaniment","salad")],
        [("staple","naan"), ("protein","butter chicken"), ("protein","dal"), ("accompaniment","raita")],
        [("staple","paratha"), ("protein","paneer"), ("accompaniment","raita"), ("accompaniment","pickle")],
        [("staple","luchi"), ("protein","cholar dal"), ("protein","aloo sabzi"), ("accompaniment","salad")],
    ],
...
def _build_slot_from_template(safe_df, slot, target_kcal, metrics,
                               ...
                               diet_pref=None, is_weekend=False):
    """
    ...
    safe_df["_s"] = safe_df.apply(
        lambda r: _score(r, slot, metrics, used_yesterday, preferred_region, diet_pref=diet_pref), axis=1
    )
...
def _score(row, slot, metrics, used_yesterday, preferred_region=None, cuisine_hint=None, diet_pref=None, **kwargs):
    """
    ...
    if not diet_pref or diet_pref in ("none", ""):
        ...
        non_veg_kw = ("chicken","mutton","fish","prawn","egg","keema","crab","omelette","bhurji")
...
def _pick(safe_df, role, slot, metrics, used_today, used_yesterday, rng,
          preferred_region=None, cuisine_hint=None, kw_boost=None, diet_pref=None):
...
def _build_slot(safe_df, slot, target_kcal, metrics, used_today, used_yesterday, rng,
                preferred_region=None, diet_pref=None,
                used_food_names_today=None, heavy_used_today=None, is_weekend=False):
    """
    ...
    if used_food_names_today:
        name_mask  = safe_df["food_name"].str.lower().apply(lambda n: n not in used_food_names_today)
        heavy_mask = safe_df["food_name"].str.lower().apply(
            lambda n: not any(hkw in n and hkw in heavy_used_today for hkw in _HEAVY_ONCE_PER_DAY)
        )
    ...
    if best_items:
        ...
        for role in structure:
            ...
            chosen = _pick(safe_df, role, slot, metrics, used_today, used_yesterday,
                           rng, preferred_region=preferred_region, diet_pref=diet_pref)
    ...
    if slot == "breakfast":
        ...
        DESSERT_KWS  = ("kheer","halwa","barfi","ladoo","jalebi","gulab jamun","rasgulla","cake","cookie")
    ...
    if slot in ("lunch","dinner"):
        ...
        has_main_staple = any(
            any(s in it["food_name"].lower()
                for s in ("rice","roti","chapati","naan","paratha","bread"))
            for it in items if it.get("meal_role") == "staple"
        )
        if has_main_staple and not has_protein:
            kws = (["dal","daal","lentil","sambar","curry","chicken","fish","egg"]
                   if not diet_pref or diet_pref in ("none","halal","")
                   else ["dal","daal","lentil","sambar","curry","paneer"])
            forced = _pick(safe_df,"protein",slot,metrics,used_today,used_yesterday,
                           rng,preferred_region=preferred_region,kw_boost=kws,diet_pref=diet_pref)
            if forced is not None:
                items.append(_item(forced, target_kcal*0.28, _role_label("protein",slot)))
...
_HEAVY_ONCE_PER_DAY = [
    "biryani","pulao","tehri","dum",       # one-pot rice dishes
    "puri","bhatura","paratha","luchi",    # fried/heavy breads (max once)
    "haleem","nihari","korma",             # heavy gravies
]
# Items that must NEVER appear in dinner if already had at lunch (very heavy)
_NO_REPEAT_LUNCH_DINNER = [
    "biryani","haleem","nihari","puri","bhatura",
]
...
def build_daily_plan(safe_df, metrics, day_num, used_yesterday=None, seed=42, preferred_region=None, festive_mode=None, diet_pref=None):
    ...
    for slot, target_kcal in metrics.meal_calories.items():
        meal = _build_slot(
            boosted_df, slot, target_kcal, metrics,
